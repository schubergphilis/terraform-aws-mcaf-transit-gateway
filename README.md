...
| <a name="input_outside_ip_address_type"></a> [outside\_ip\_address\_type](#input\_outside\_ip\_address\_type) | The type of IP address to use for the outside interface. Valid values are 'PublicIpv4' and 'PrivateIpv4'. | `string` | `"PublicIpv4"` | no |
